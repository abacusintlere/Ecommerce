        ...
        <div class="row">
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    <span class="icon-stat-label">Purchased Amount</span>
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{ $total_purchased }}</span>
                  </div>    
                  <div class="col-xs-4 text-center">
            ...
            <div class="col-md-3 col-sm-6">    
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    <span class="icon-stat-label">Today Delievered</span>
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{ $today_canceled }}</span>
                  </div>    
                  <div class="col-xs-4 text-center">
                    <i class="fa fa-gift icon-stat-visual bg-secondary"></i>
                  </div>
