                    ...
                    <div class="panel panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent='update'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" id="newImage" name="newImage" class="form-control input-md" placeholder="Image" wire:model="newImage">
                                    @if($newImage)
                                        <img src="{{ $newImage->temporaryUrl() }}" alt="" width="220" height="220">
                                    @else
                                        <img src="{{ asset('assets/images/sliders/') }}{{ $image }}" alt="" width="220" height="220">
                                    @endif
                                </div>
                            </div>
